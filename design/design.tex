	...
	\item[•]MongoConsumer
	      ...
	      \begin{itemize}
		      ...
		      \item[-]getTopicsForProcessing
		            ...
		            \\This convenience method returns a list of all topics as strings.
...
\newpage
	...
	\item[•] AddressesAndLinks
	      \\Implements IAggregator. This aggregator produces a list of network nodes that show up in the datastream and a list of connections between the nodes.
	      Methods
	      \begin{itemize}
		      \item[-]processData
